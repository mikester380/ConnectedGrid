...
!(function (t, e) {
    ...
    function Ab(e, r, i) {
        ...
        if (!p) {
            if (
                ("," === e.substr(-1) && (e = e.substr(0, e.length - 1)), Et[e])
            )
                p = Et[e]
            else if ("#" === e.charAt(0)) {
                if (
        ...
        Ut =
            ...
            (qt.timeScale = function timeScale(t) {
                ...
                return (
                    ...
                    this.totalTime(
                        kt(-Math.abs(this._delay), this._tDur, e),
                        !0
                    ),
                    Ha(this),
                ...
                if (
                    ...
                    (s = a.timeline =
                        new Xt({
                            ...
                            defaults: k || {},
                            targets:
                                P && "nested" === P.data ? P.vars.targets : A,
                        })).kill(),
                    ...
                    for (o = 0; o < h; o++)
                        ((u = ua(r, Ht)).stagger = 0),
                            ...
                            (u.delay =
                                (+Kt(m, _assertThisInitialized(a), o, f, A) ||
                                    0) - a._delay),
                            !T &&
                                1 === h &&
                                u.delay &&
            ...
            return (
                ...
                m !== wr &&
                    ...
                    r.svg &&
                        ...
                        (r.forceCSS =
                            t.setAttribute("transform", "") || !ie(Pd(t, dr))),
